  ...
  const publications = [
    {
      citation: (
        <>
          Islam, M. R., Anwar, R. H., Mastorakis, S., & Raza, M. T. (2024). 
          <em> Characterizing Encrypted Application Traffic Through Cellular Radio Interface Protocol.</em> 
          In <strong>Proceedings of the IEEE 21st International Conference on Mobile Ad-Hoc and Smart Systems (MASS)</strong>, 
          Seoul, Korea, pp. 321–329. IEEE. https://doi.org/10.1109/MASS62177.2024.00050
        </>
      ),
      link: "https://ieeexplore.ieee.org/document/10723461",
    },
    {
      citation: (
        <>
